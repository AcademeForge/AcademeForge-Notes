...
<!-- Flashcard Button -->
<button class="option" onclick="openFlashcardPopup()" style="background-color: #3498db; color: white; width: 90%; margin-top: 20px;">
    Quick Revision
</button>

<!-- Flashcard Popup -->
<div class="popup-bg hidden" id="flashcardPopup">
    <div class="popup-box">
        <button class="close-btn" onclick="closeFlashcardPopup()">Close</button>
