...
document.addEventListener("DOMContentLoaded", function() {
    ...
    if (window.location.pathname.includes("login")) {
        ...
        let announcementBtn = document.createElement("button");
        announcementBtn.innerHTML = "📢 Announcement";
        announcementBtn.className = "announcement-btn";
        announcementBtn.onclick = showAnnouncement;
        ...
        modal.innerHTML = `
            <div class="modal-content">
                ...
                <h2>📢 Announcement</h2>
                <p>We will start sharing materials from 1st April! <br>Join our Telegram group:  
                    <a href="https://t.me/AcademeForge" target="_blank">Click Here</a>
                </p>
            </div>
        `;

        // Append elements to the body
        document.body.appendChild(announcementBtn);
